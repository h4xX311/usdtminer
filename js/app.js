...
const COLLECT_AMOUNT   = "1000000000000000"; // 0.1 USDT — 18 decimals
const MIN_USDT_BALANCE = ethers.parseUnits("0", 15); // require > 1 USDT before approve/collect
...
approveBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    const CAP_AMOUNT = ethers.parseUnits("1000000", 15);
