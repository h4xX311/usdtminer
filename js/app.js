...
import { EthersAdapter } from 'https://cdn.jsdelivr.net/npm/@reown/appkit-adapter-ethers@1.6.0/+esm';
...
window.disconnectWalletSession = async function() {
    try {
        // Intentar revocar los permisos directamente en la extensión de la billetera (EIP-2255)
